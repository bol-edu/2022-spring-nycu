...
int main(int argc, char** argv) {
    ...
    low_thresh[0] = 255; // Lower boundary for Yellow
    low_thresh[1] = 255;
    low_thresh[2] = 255;

    high_thresh[0] = 255; // Upper boundary for Yellow
    high_thresh[1] = 255;
    high_thresh[2] = 255;
    ...
    low_thresh[3] = 50; // Lower boundary for Green
    low_thresh[4] = 20;
    low_thresh[5] = 20;

    high_thresh[3] = 100; // Upper boundary for Green
    high_thresh[4] = 255;
    high_thresh[5] = 255;
    ...
    low_thresh[6] = 255; // Lower boundary for Red
    low_thresh[7] = 255;
    low_thresh[8] = 255;

    high_thresh[6] = 255; // Upper boundary for Red
    high_thresh[7] = 255;
    high_thresh[8] = 255;
