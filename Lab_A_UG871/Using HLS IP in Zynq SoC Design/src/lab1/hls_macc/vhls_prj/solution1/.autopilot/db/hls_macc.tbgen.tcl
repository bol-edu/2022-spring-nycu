...
set C_modelArgMapList {[ 
	{ "Name" : "a", "interface" : "axi_slave", "bundle":"HLS_MACC_PERIPH_BUS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":16}, "offset_end" : {"in":23}} , 
 	{ "Name" : "b", "interface" : "axi_slave", "bundle":"HLS_MACC_PERIPH_BUS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":24}, "offset_end" : {"in":31}} , 
 	{ "Name" : "accum", "interface" : "axi_slave", "bundle":"HLS_MACC_PERIPH_BUS","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "offset" : {"out":32}, "offset_end" : {"out":39}} , 
 	{ "Name" : "accum_clr", "interface" : "axi_slave", "bundle":"HLS_MACC_PERIPH_BUS","type":"ap_none","bitwidth" : 1, "direction" : "READONLY", "offset" : {"in":48}, "offset_end" : {"in":55}} , 
 	{ "Name" : "ap_local_deadlock", "interface" : "axi_slave", "bundle":"HLS_MACC_PERIPH_BUS","type":"ap_none","bitwidth" : 1, "direction" : "WRITEONLY", "offset" : {"out":0}, "offset_end" : {"out":4294967295}} ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_32s_32_5_1_U1", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	hls_macc {
		...
		accum {Type O LastRead -1 FirstWrite 7}
