...
set ID 1
set hasByteEnable 0
set MemName hls_real2xfft_Loop_sliding_win_delay_proc1_delay_line_Array_SHIFTREG_AUTO_0R0W
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { din_TVALID { I 1 bit } din_TDATA { I 16 vector } din_TREADY { O 1 bit } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { nodelay_V_1_din { O 16 vector } nodelay_V_1_full_n { I 1 bit } nodelay_V_1_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { delayed_V_1_din { O 16 vector } delayed_V_1_full_n { I 1 bit } delayed_V_1_write { O 1 bit } } \
} "
}
