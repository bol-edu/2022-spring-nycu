...
module hls_real2xfft_Loop_sliding_win_delay_proc1_delay_line_Array_SHIFTREG_AUTO_0R0W_core (
    clk,
    ce,
    din,
    addr,
...
module hls_real2xfft_Loop_sliding_win_delay_proc1_delay_line_Array_SHIFTREG_AUTO_0R0W (
    clk,
    reset,
    address0,
    ce0,
...
hls_real2xfft_Loop_sliding_win_delay_proc1_delay_line_Array_SHIFTREG_AUTO_0R0W_core #(
    ...
    .DEPTH( AddressRange ))
hls_real2xfft_Loop_sliding_win_delay_proc1_delay_line_Array_SHIFTREG_AUTO_0R0W_core_U(
    .clk(clk),
    .ce(we0),
    .din(d0),
    .addr(address0),
