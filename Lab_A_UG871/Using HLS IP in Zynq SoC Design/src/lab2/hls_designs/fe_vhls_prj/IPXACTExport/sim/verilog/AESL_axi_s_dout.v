...
`define TV_OUT_dout_TDATA "../tv/rtldatafile/rtl.hls_real2xfft.autotvout_dout.dat"
...
module AESL_axi_s_dout (
    ...
    reg [48 - 1:0] dout_TDATA_write_data;
    reg dout_TDATA_read_en;
    wire [48 - 1:0] dout_TDATA_read_data;
    
    fifo #(512, 48) fifo_dout_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    assign TRAN_dout_TREADY = ~(dout_TDATA_full);
