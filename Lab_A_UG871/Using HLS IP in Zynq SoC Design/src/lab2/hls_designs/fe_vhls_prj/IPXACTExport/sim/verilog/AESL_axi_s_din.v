...
`define TV_IN_din_TDATA "../tv/cdatafile/c.hls_real2xfft.autotvin_din.dat"
...
module AESL_axi_s_din (
    ...
    reg [16 - 1:0] din_TDATA_write_data;
    reg din_TDATA_read_en;
    wire [16 - 1:0] din_TDATA_read_data;
    
    fifo #(512, 16) fifo_din_TDATA (
        .reset(1'b0),
        .write_clock(clk),
