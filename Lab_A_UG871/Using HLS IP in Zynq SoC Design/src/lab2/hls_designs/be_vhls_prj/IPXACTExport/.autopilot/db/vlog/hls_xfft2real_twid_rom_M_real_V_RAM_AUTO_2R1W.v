...
module hls_xfft2real_twid_rom_M_real_V_RAM_AUTO_2R1W
#(parameter
    DataWidth    = 15,
    AddressRange = 32,
    AddressWidth = 8,
...
generate
    for (i = 0; i < BufferCount; i = i + 1) begin : gen_buffer
        hls_xfft2real_twid_rom_M_real_V_RAM_AUTO_2R1W_memcore hls_xfft2real_twid_rom_M_real_V_RAM_AUTO_2R1W_memcore_U (
            .clk      ( clk ),
            .reset    ( reset ),
            .ce0      ( buf_ce0[i] ),
            .we0      ( buf_we0[i] ),
