set moduleName Loop_realfft_be_descramble_proc2_Pipeline_realfft_be_descramble
set isTopModule 0
...
set C_modelName {Loop_realfft_be_descramble_proc2_Pipeline_realfft_be_descramble}
...
set C_modelArgList {
	...
	{ descramble_buf_M_imag_V_1_load int 16 regular  }
	{ descramble_buf_M_real_V_1_load int 16 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "descramble_buf_M_real_V", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "descramble_buf_M_imag_V_1_load", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "descramble_buf_M_real_V_1_load", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ real_spectrum_lo_i_din sc_out sc_lv 32 signal 8 } 
	{ real_spectrum_lo_i_full_n sc_in sc_logic 1 signal 8 } 
	{ real_spectrum_lo_i_write sc_out sc_logic 1 signal 8 } 
	{ descramble_buf_M_real_V_address0 sc_out sc_lv 8 signal 0 } 
	{ descramble_buf_M_real_V_ce0 sc_out sc_logic 1 signal 0 } 
	{ descramble_buf_M_real_V_q0 sc_in sc_lv 16 signal 0 } 
	{ descramble_buf_M_imag_V_address0 sc_out sc_lv 8 signal 1 } 
	{ descramble_buf_M_imag_V_ce0 sc_out sc_logic 1 signal 1 } 
	{ descramble_buf_M_imag_V_q0 sc_in sc_lv 16 signal 1 } 
	{ descramble_buf_M_imag_V_1_address0 sc_out sc_lv 8 signal 2 } 
	{ descramble_buf_M_imag_V_1_ce0 sc_out sc_logic 1 signal 2 } 
	{ descramble_buf_M_imag_V_1_q0 sc_in sc_lv 16 signal 2 } 
	{ descramble_buf_M_real_V_1_address0 sc_out sc_lv 8 signal 3 } 
	{ descramble_buf_M_real_V_1_ce0 sc_out sc_logic 1 signal 3 } 
	{ descramble_buf_M_real_V_1_q0 sc_in sc_lv 16 signal 3 } 
	{ twid_rom_M_real_V_address0 sc_out sc_lv 8 signal 4 } 
	{ twid_rom_M_real_V_ce0 sc_out sc_logic 1 signal 4 } 
	{ twid_rom_M_real_V_q0 sc_in sc_lv 15 signal 4 } 
	{ twid_rom_M_imag_V_address0 sc_out sc_lv 8 signal 5 } 
	{ twid_rom_M_imag_V_ce0 sc_out sc_logic 1 signal 5 } 
	{ twid_rom_M_imag_V_q0 sc_in sc_lv 16 signal 5 } 
	{ descramble_buf_M_imag_V_1_load sc_in sc_lv 16 signal 6 } 
	{ descramble_buf_M_real_V_1_load sc_in sc_lv 16 signal 7 } 
	{ real_spectrum_hi_buf_M_real_V_address0 sc_out sc_lv 8 signal 9 } 
	{ real_spectrum_hi_buf_M_real_V_ce0 sc_out sc_logic 1 signal 9 } 
	{ real_spectrum_hi_buf_M_real_V_we0 sc_out sc_logic 1 signal 9 } 
	{ real_spectrum_hi_buf_M_real_V_d0 sc_out sc_lv 16 signal 9 } 
	{ real_spectrum_hi_buf_M_imag_V_address0 sc_out sc_lv 8 signal 10 } 
	{ real_spectrum_hi_buf_M_imag_V_ce0 sc_out sc_logic 1 signal 10 } 
	{ real_spectrum_hi_buf_M_imag_V_we0 sc_out sc_logic 1 signal 10 } 
	{ real_spectrum_hi_buf_M_imag_V_d0 sc_out sc_lv 16 signal 10 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "descramble_buf_M_imag_V_1_load", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "descramble_buf_M_imag_V_1_load", "role": "default" }} , 
 	{ "name": "descramble_buf_M_real_V_1_load", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "descramble_buf_M_real_V_1_load", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	descramble_buf_M_imag_V_1_load { ap_none {  { descramble_buf_M_imag_V_1_load in_data 0 16 } } }
	descramble_buf_M_real_V_1_load { ap_none {  { descramble_buf_M_real_V_1_load in_data 0 16 } } }
