...
unsigned int ap_apatb_din_cap_bc;
static AESL_RUNTIME_BC __xlx_din_V_size_Reader("../tv/stream_size/stream_size_in_din.dat");
unsigned int ap_apatb_dout_cap_bc;
static AESL_RUNTIME_BC __xlx_dout_V_size_Reader("../tv/stream_size/stream_size_out_dout.dat");
...
extern "C" void apatb_hls_xfft2real_hw(volatile void * __xlx_apatb_param_din, volatile void * __xlx_apatb_param_dout) {
  ...
  ap_apatb_din_cap_bc = __xlx_din_tmp_vec.size();
  // store input buffer
  ...
  ap_apatb_dout_cap_bc = __xlx_dout_V_size_Reader.read_size();
  __cosim_s6__* __xlx_dout_input_buffer= new __cosim_s6__[ap_apatb_dout_cap_bc];
  // DUT call
  hls_xfft2real(__xlx_din_input_buffer, __xlx_dout_input_buffer);
  for (unsigned i = 0; i <ap_apatb_dout_cap_bc; ++i)
