set moduleName Loop_realfft_be_rev_real_hi_proc3
set isTopModule 0
...
set C_modelName {Loop_realfft_be_rev_real_hi_proc3}
set C_modelType { void 0 }
set C_modelArgList {
	{ real_spectrum_hi_buf_M_real_V int 16 regular {array 256 { 1 3 } 2 1 }  }
	{ real_spectrum_hi_buf_M_imag_V int 16 regular {array 256 { 1 3 } 2 1 }  }
	{ real_spectrum_hi_i int 32 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "real_spectrum_hi_buf_M_real_V", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "real_spectrum_hi_i", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ real_spectrum_hi_i_din sc_out sc_lv 32 signal 2 } 
	{ real_spectrum_hi_i_full_n sc_in sc_logic 1 signal 2 } 
	{ real_spectrum_hi_i_write sc_out sc_logic 1 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "real_spectrum_hi_i_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "real_spectrum_hi_i", "role": "din" }} , 
 	{ "name": "real_spectrum_hi_i_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "real_spectrum_hi_i", "role": "full_n" }} , 
 	{ "name": "real_spectrum_hi_i_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "real_spectrum_hi_i", "role": "write" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "real_spectrum_hi_i", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "8", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	real_spectrum_hi_i { ap_fifo {  { real_spectrum_hi_i_din fifo_data 1 32 }  { real_spectrum_hi_i_full_n fifo_status 0 1 }  { real_spectrum_hi_i_write fifo_update 1 1 } } }
}
